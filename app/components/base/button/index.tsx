...
const Button: FC<IButtonProps> = ({
  ...
  return (
    <div
      className={`flex tablet:ml-auto justify-center justify-items-center content-center h-9 leading-5 rounded-lg px-4 py-2 text-base ${style} ${className && className}`}
